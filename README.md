...
|---------|--------|-------------|
| [v2](./v2/README.md) | Current | TypeScript/React single-page app with interactive assumption/component editors and XLSX export |
| [v1](./v1/README.md) | Legacy | Original Python version with a self-contained pricing workbook wizard |
...
- [`/v2/`](https://aliuly.github.io/xlpricer/v2/) — the current SPA build
